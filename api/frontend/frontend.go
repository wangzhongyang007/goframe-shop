...
import (
	...
	"shop/api/frontend/address"
	"shop/api/frontend/article"
	"shop/api/frontend/cart"
	"shop/api/frontend/category"
	"shop/api/frontend/collection"
	"shop/api/frontend/comment"
	"shop/api/frontend/consignee"
	"shop/api/frontend/goods"
	"shop/api/frontend/order"
	"shop/api/frontend/praise"
	"shop/api/frontend/refund"
	"shop/api/frontend/userCoupon"
	"shop/internal/service/frontendLogin"
	"shop/middleware"
)
