...
CREATE TABLE `admin_info` (
  ...
  `role_ids` varchar(50) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '角色ids',
...
-- ----------------------------
BEGIN;
INSERT INTO `admin_info` VALUES (1, 'admin', '080a5184d928133da3c972ed3c91d77d', '1,2', '2022-09-25 16:40:43', '2022-09-25 16:40:43', NULL, 'crELbJLqhH', 1);
INSERT INTO `admin_info` VALUES (3, 'wangzhongyang', '5fd3d9626d41b66c3bd667bb61db3805', '0', '2022-07-19 10:50:20', '2022-07-19 10:50:20', NULL, 'TCaGJgMS6j', 0);
COMMIT;
...
CREATE TABLE `coupon_info` (
  ...
  `goods_ids` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '关联使用的goods_ids  逗号分隔',
...
CREATE TABLE `permission_info` (
  `id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(30) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '权限名称',
  `path` varchar(100) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '路径',
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  `deleted_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `role_info` (
  `id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(50) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '角色名称',
...
-- ----------------------------
BEGIN;
INSERT INTO `rotation_info` VALUES (1, '111', '11', 10, '2022-07-19 04:53:01', '2022-07-19 04:59:24', '2022-07-19 05:04:03');
INSERT INTO `rotation_info` VALUES (2, '1', '1', 1, '2022-07-19 05:15:20', '2022-07-19 05:15:20', NULL);
INSERT INTO `rotation_info` VALUES (3, '1', '1', 1, '2022-07-19 05:15:21', '2022-07-19 05:15:21', NULL);
COMMIT;
